...
} else if (wallet == "Skrill") {
  imagePath = "assets/images/skrill.webp";
} else if (wallet == "Wise") {
  imagePath = "assets/images/wise.webp";
} else if (wallet == "Neteller") {
  imagePath = "assets/images/neteller.png";
} else {
  imagePath = "assets/images/pm.webp";
}
    return Container(
